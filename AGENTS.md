...
- **PyTorch must never become a runtime dependency.** Its bundled OpenMP collides with CTranslate2's on Windows (the DLL Error #15 class). Model-conversion extras stay out of `pyproject.toml`.
